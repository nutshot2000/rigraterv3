  ...
  return (
    <div className="w-64 bg-slate-900/80 backdrop-blur-sm border-r border-slate-700/50 p-4 flex flex-col">
      <div className="space-y-2 flex-grow">
        <button
          className={getButtonClass(currentPage === Page.ADMIN_PRODUCTS)}
          onClick={() => onNavigate(Page.ADMIN_PRODUCTS)}
        >
        ...
        <button
          className={getButtonClass(currentPage === Page.ADMIN_BLOG)}
          onClick={() => onNavigate(Page.ADMIN_BLOG)}
        >
